...
epsilon_r(1) = 0.025;%0.01301; % Lehrsches Daempfungsmass der ersten Mode (die keine Starrkoerpermode ist)
epsilon_r(2) = 0.018;%0.005379; % Exp. 166.8Hz
...
omega_0r = omegatmp([1,3]);%ausgewaehlte Moden mit f=[14.736,159.0289]Hz%omegatmp([1,3]);
...
% save D_damping_proportional D % wenn Ergebnis zufriedenstellend -> abspeichern
