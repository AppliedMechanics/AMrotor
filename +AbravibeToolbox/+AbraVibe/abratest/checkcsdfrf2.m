% Test APSDSP, ACSDSP and XMTRX2FRF by synthesizing data and verify input/outputs

% This script assumes that APSDSP is verified already (with checkapsdsp) 
% Calculating FRF's with ACSDSP and APSDSP then checks the FRF as well as CSD
% scalings.
...
fprintf(fid,'Starting checkcsdfrf2...\n')
...
% Done.
fprintf('Verification completed. If no outputs where printed, the ACSDSP and XMTRX2FRF commands work as they should\n')