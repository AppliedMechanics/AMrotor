function [ Koeff ] = MuszynskaModelNewLaminar( self, sys,init )
...
%% Modelgleichungen
%Laminar flow to Gasch
dotV=(sys.p*(sys.d+sys.S)*pi*sys.S^3)/(12*sys.eta*sys.L); %Korrekt 08.12.18
u=dotV/sys.A;
lambda=(sys.S/(2*sys.L))*((sys.p*2/(sys.rho*u^2))-1-sys.xi_ein);
