...
Afterwards the necessary scripts can be executed (see :ref:`Examples` and :ref:`Usage`). 


******
Source
******
The source code of AMrotor can be downloaded from https://gitlab.lrz.de/jmaierhofer/AMrotor
