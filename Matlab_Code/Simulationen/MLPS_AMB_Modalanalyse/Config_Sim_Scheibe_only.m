...
% Rotor Config
% Geometrie nur Scheibe ohne Spannhuelsen
...
cnfg.cnfg_rotor.geo_nodes = {...
    [z(6)-z(6) ra(4) ri(4)], [z(7)-z(6) ra(4) ri(4)], ... % Abschnitt D
    [z(7)-z(6) ra(5) ri(5)], [z(8)-z(6) ra(5) ri(5)], ... % Abschnitt E
    [z(8)-z(6) ra(6) ri(6)], [z(9)-z(6) ra(6) ri(6)], ... % Abschnitt F
    [z(9)-z(6) ra(5) ri(5)], [z(10)-z(6) ra(5) ri(5)], ... % Abschnitt E
    [z(10)-z(6) ra(4) ri(4)], [z(11)-z(6) ra(4) ri(4)], ... % Abschnitt D
    }; % Endknoten
clear A I ra ri z
