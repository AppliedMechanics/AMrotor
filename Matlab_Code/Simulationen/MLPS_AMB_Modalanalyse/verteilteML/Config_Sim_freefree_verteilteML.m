...
% factor = 1;
% cnfg.cnfg_disc(count).m=cnfg.cnfg_disc(count).m*factor;
% cnfg.cnfg_disc(count).Jx=cnfg.cnfg_disc(count).Jx*factor;
% cnfg.cnfg_disc(count).Jz=cnfg.cnfg_disc(count).Jz*factor;
% cnfg.cnfg_disc(count).Jp = cnfg.cnfg_disc(count).Jz;     %disc polar mom. of inertia [kg*m^2]
% 
% 
% count = count+1;
