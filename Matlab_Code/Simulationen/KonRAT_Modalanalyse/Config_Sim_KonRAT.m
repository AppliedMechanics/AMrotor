...
% Rotor Config
delta = 1;
cnfg.cnfg_rotor.geo_nodes = {[0 0 0], [0 delta 0], [10 delta 0], [10 13 0], [30 13 0], [30 14 0], [55.182 14 0], [55.182 15 0], [220 15 0], [220 18 0], [260 18 0]};
...
cnfg.cnfg_disc(count).m = 0.49;                             %disc mass [kg]
cnfg.cnfg_disc(count).Jx = 1.9795e-4;                       %disc mom. of inertia [kg*m^2]
cnfg.cnfg_disc(count).Jz = 1.512e-4;                        %disc mom. of inertia [kg*m^2]
