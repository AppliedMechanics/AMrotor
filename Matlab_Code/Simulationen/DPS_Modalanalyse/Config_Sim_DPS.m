...
r_Laeufer_D_innen = 11e-3; % Innenradius D Laeufer, sodass I und m wie in Realität
r_Laeufer_ML_innen = 1e-3; % Innenradius ML Laeufer, sodass I und m wie in Realität
...
sealModel.sys.D = 0.1; %sys.d + 2 * 0.1397e-3;          % Außendurchmesser
sealModel.sys.L = 0.02;                       % Spaltlänge
...
sealModel.sys.p = 3e5;                     % Druckdifferenz über Dichtung in Pa, N/m^2, 1bar=10^5Pa
