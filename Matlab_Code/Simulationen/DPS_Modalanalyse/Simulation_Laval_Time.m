...
St_Lsg = Experiments.Stationaere_Lsg( r , 0e3:5e2:12e3 , (0:0.001:1) );%St_Lsg = Experiments.Stationaere_Lsg(r,[0:50:10e3],[0:0.001:2]); %obj = Stationaere_Lsg(a,drehzahlvektor,time)
...
St_Lsg.save_data('St_Lsg_Laval_U_fwd_bwd_sweep_0_12krpm');
