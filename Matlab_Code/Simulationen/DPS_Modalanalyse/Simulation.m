...
St_Lsg = Experiments.Stationaere_Lsg( r , 0:2e2:6e3 , (0:0.001:10) );%St_Lsg = Experiments.Stationaere_Lsg(r,[0:50:10e3],[0:0.001:2]); %obj = Stationaere_Lsg(a,drehzahlvektor,time)
