...
% cnfg.cnfg_rotor.geo_nodes = {[0 0 0], [0 0.2 0], [0.250 0.2 0], [0.250 0.2 0], [0.350 0.2 0], [0.350 0.2 0], [0.600 0.2 0], [0.600 0 0]};
...
cnfg.cnfg_load(count).betrag = 1e-2;%1e-2;%5e-6;
...
% cnfg.cnfg_load(count).frequency_x= 100;  %in Hz, Endfrequenz
