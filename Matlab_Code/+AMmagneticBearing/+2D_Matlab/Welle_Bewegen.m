function [Verschiebung]=Welle_Bewegen(AltesMesh,delta_x,delta_y)
%% Variablen
persistent model
...
structuralBC(model,'Edge',[1:4],'Displacement',[delta_x,delta_y]);
%% Lösen
Lo=solve(model);
Dis=interpolateDisplacement(Lo,AltesMesh.Nodes(1,:),AltesMesh.Nodes(2,:));
