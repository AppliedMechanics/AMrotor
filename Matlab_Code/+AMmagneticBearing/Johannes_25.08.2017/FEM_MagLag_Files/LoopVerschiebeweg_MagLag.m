...
%   in den Spulen durchlaufen und ein Kennfeld erstellt / es muss
%   "pdvA_MagLag" so angepasst werden, dass der Verschiebeweg übergeben
%   wird
...
% Setup
dV=linspace(1e-9,1e-5,250);    % Verschiebeweg in m
Position=[0 0.6]*1e-3;          % Wellenposition (x, y) in metern
