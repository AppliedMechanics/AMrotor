...
cnfg.cnfg_rotor.rotor_dimensions = [0,8,0;500,8,0;515,150,0;800,8,0]*1e-3; %[m] %Angefangen bei 0, die Durchmessersprünge am ende des Abschnites eingeben
...
cnfg.cnfg_sensor=[];
  ...
  cnfg.cnfg_sensor(1).position=0.5075;
