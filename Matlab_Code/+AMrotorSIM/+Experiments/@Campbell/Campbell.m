...
%                 EV_for_ref = EV_for_puffer(:,1:size(EV_for_ref,2)); EV_back_ref = EV_back_puffer(:,1:size(EV_back_ref,2)); % use reference EV from the caluculation of the time step befor
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function zeroCrossings = read_zero_crossing(obj)
            zeroCrossings.forward = obj.zeroCrossingDampingForwardOmega;
            zeroCrossings.backward = obj.zeroCrossingDampingBackwardOmega;
        end
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
